...
if(1 != 1){
	...
	if(bookMarkletDiv == null){
		...
		bookMarkletDiv.style.border = "4px solid #0047BD";
		...
		closeMe.innerHTML = "<img src='"+ doc.odooBaseURL + "themes/images/close.gif' title='Close Window' " + "alt='Close Window' border=0>";
		...
		popUp.id="__odooBookmarkletFrame__";
		popUp.name="__odooBookmarkletFrame__";
...
function getTargetURL(){
	...
	return doc.odooBaseURL+"index.php?module=Emails&action=SaveBookmarklet&base_only=true&subject="+
...
window.top.removeMe = function(){
	if(navigator.userAgent.toLowerCase().indexOf("msie") == -1){
		...
		odooGmailBookmarkletWindow.close();
	}
}
})();